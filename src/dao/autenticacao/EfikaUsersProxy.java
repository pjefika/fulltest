...
public class EfikaUsersProxy implements dao.autenticacao.EfikaUsers_PortType {
  private String _endpoint = null;
  private dao.autenticacao.EfikaUsers_PortType efikaUsers_PortType = null;
  ...
  private void _initEfikaUsersProxy() {
    try {
      efikaUsers_PortType = (new dao.autenticacao.EfikaUsers_ServiceLocator()).get_8();
  ...
  public dao.autenticacao.EfikaUsers_PortType getEfikaUsers_PortType() {
    if (efikaUsers_PortType == null)
      _initEfikaUsersProxy();
