...
package dao.autenticacao;

@SuppressWarnings("serial")
public class EfikaUsers_ServiceLocator extends org.apache.axis.client.Service implements dao.autenticacao.EfikaUsers_Service {
    ...
    public dao.autenticacao.EfikaUsers_PortType get_8() throws javax.xml.rpc.ServiceException {
    ...
    public dao.autenticacao.EfikaUsers_PortType get_8(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            dao.autenticacao.EfikaUsersSoapBindingStub _stub = new dao.autenticacao.EfikaUsersSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(@SuppressWarnings("rawtypes") Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (dao.autenticacao.EfikaUsers_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                dao.autenticacao.EfikaUsersSoapBindingStub _stub = new dao.autenticacao.EfikaUsersSoapBindingStub(new java.net.URL(_8_address), this);
                _stub.setPortName(get_8WSDDServiceName());
                return _stub;
            }
        }
