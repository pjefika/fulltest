/**
 * ConsultarParametrosDSLOut.java
 *
...
public class ConsultarParametrosDSLOut  extends com.gvt.www.ws.eai.configuradoronline.contingent.types.ResponseStatus  implements java.io.Serializable {
    ...
    public ConsultarParametrosDSLOut() {
    }
    ...
    /**
     * Gets the diagnosticos value for this ConsultarParametrosDSLOut.
     * 
     * @return diagnosticos
     */
    ...
    /**
     * Sets the diagnosticos value for this ConsultarParametrosDSLOut.
     * 
     * @param diagnosticos
     */
    ...
    public com.gvt.www.ws.eai.configuradoronline.devicemanagement.types.DiagnosticoParam[] getDiagnosticos(int i) {
        return this.diagnosticos[i];
    }

    public void setDiagnosticos(int i, com.gvt.www.ws.eai.configuradoronline.devicemanagement.types.DiagnosticoParam[] _value) {
        this.diagnosticos[i] = _value;
    }


    /**
     * Gets the statusAcs value for this ConsultarParametrosDSLOut.
     * 
     * @return statusAcs
     */
    ...
    /**
     * Sets the statusAcs value for this ConsultarParametrosDSLOut.
     * 
     * @param statusAcs
     */
    ...
    /**
     * Gets the deviceId value for this ConsultarParametrosDSLOut.
     * 
     * @return deviceId
     */
    ...
    /**
     * Sets the deviceId value for this ConsultarParametrosDSLOut.
     * 
     * @param deviceId
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ConsultarParametrosDSLOut)) return false;
        ConsultarParametrosDSLOut other = (ConsultarParametrosDSLOut) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ConsultarParametrosDSLOut.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.gvt.com/ws/eai/configuradoronline/devicemanagement/services", "consultarParametrosDSLOut"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.gvt.com/ws/eai/configuradoronline/devicemanagement/types", "Diagnostico"));
