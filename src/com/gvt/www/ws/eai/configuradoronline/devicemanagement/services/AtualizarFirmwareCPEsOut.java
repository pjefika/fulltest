...
public class AtualizarFirmwareCPEsOut  extends com.gvt.www.ws.eai.configuradoronline.contingent.types.ResponseStatus  implements java.io.Serializable {
    private com.gvt.www.ws.eai.configuradoronline.devicemanagement.types.StatusAtualizacaoFirmware status;

    public AtualizarFirmwareCPEsOut() {
    }
    ...
    /**
     * Gets the status value for this AtualizarFirmwareCPEsOut.
     * 
     * @return status
     */
    ...
    /**
     * Sets the status value for this AtualizarFirmwareCPEsOut.
     * 
     * @param status
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof AtualizarFirmwareCPEsOut)) return false;
        AtualizarFirmwareCPEsOut other = (AtualizarFirmwareCPEsOut) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(AtualizarFirmwareCPEsOut.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.gvt.com/ws/eai/configuradoronline/devicemanagement/services", "AtualizarFirmwareCPEsOut"));
