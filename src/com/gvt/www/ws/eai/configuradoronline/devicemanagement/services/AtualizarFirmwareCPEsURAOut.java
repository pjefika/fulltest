/**
 * AtualizarFirmwareCPEsURAOut.java
 *
...
public class AtualizarFirmwareCPEsURAOut  extends com.gvt.www.ws.eai.configuradoronline.contingent.types.ResponseStatus  implements java.io.Serializable {
    private com.gvt.www.ws.eai.configuradoronline.devicemanagement.types.StatusAtualizacaoFirmware status;

    public AtualizarFirmwareCPEsURAOut() {
    }
    ...
    /**
     * Gets the status value for this AtualizarFirmwareCPEsURAOut.
     * 
     * @return status
     */
    ...
    /**
     * Sets the status value for this AtualizarFirmwareCPEsURAOut.
     * 
     * @param status
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof AtualizarFirmwareCPEsURAOut)) return false;
        AtualizarFirmwareCPEsURAOut other = (AtualizarFirmwareCPEsURAOut) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(AtualizarFirmwareCPEsURAOut.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.gvt.com/ws/eai/configuradoronline/devicemanagement/services", "AtualizarFirmwareCPEsURAOut"));
