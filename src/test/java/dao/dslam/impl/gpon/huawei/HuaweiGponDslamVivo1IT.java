    ...
    public static void setUpClass() {
        ...
        try {
            cust = (EfikaCustomer) new JacksonMapper(EfikaCustomer.class).deserialize("{"
                    + "   \"designador\":\"SPO-022408654038-013\","
                    + "   \"instancia\":\"110008437279000\","
                    + "   \"designadorAcesso\":\"SPO-29698954-069\","
                    + "   \"designadorTv\":\"TV-SPO-81NR6O3459-050\","
                    + "   \"rede\":{"
                    + "      \"tipo\":\"GPON\","
                    + "      \"origem\":\"ONLINE\","
                    + "      \"planta\":\"VIVO1\","
                    + "      \"ipDslam\":\"10.23.233.104\","
