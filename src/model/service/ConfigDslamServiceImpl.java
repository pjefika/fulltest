...
public class ConfigDslamServiceImpl extends ConfigGenericService implements ConfigPortaService<ConfiguracaoDSLAMS>, ConfigSetterMetalicoService, ConfigGetterMetalicoService {
    ...
    @Override
    public ConfiguracaoDSLAMS consultar() throws Exception {
        ConfiguracaoDSLAMS config = new ConfiguracaoDSLAMS();
